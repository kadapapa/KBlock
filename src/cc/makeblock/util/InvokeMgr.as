package cc.makeblock.util
{
	...
	public class InvokeMgr
	{
		public function InvokeMgr()
		{
			...
			KBlock.app.stage.addEventListener(NativeDragEvent.NATIVE_DRAG_ENTER, __onDragEnter);
			KBlock.app.stage.addEventListener(NativeDragEvent.NATIVE_DRAG_DROP, __onDragDrop);
		}
		...
		private function __onDragDrop(evt:NativeDragEvent):void
		{
			...
			KBlock.app.runtime.selectedProjectFile(file);
		}
		...
		private function __onInvoked(evt:InvokeEvent):void
		{
			...
			if(Boolean(arg)){
				KBlock.app.runtime.selectedProjectFile(new File(arg));
			}
		}
	}
}