...
//		if((KBlock.app.isIn3D || Capabilities.cpuArchitecture != 'x86') && !force) return [];

		var scale:Number = targetObj.isStage ? 1 : KBlock.app.stagePane.scaleX;
		...
		if (filterDict["pixelate"] != 0) {
			...
			if (targetObj == KBlock.app.stagePane) n *= KBlock.app.stagePane.scaleX;
