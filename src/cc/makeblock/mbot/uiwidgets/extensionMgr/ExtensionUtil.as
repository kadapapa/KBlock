package cc.makeblock.mbot.uiwidgets.extensionMgr
{
	...
	public class ExtensionUtil
	{
		...
		static public function OnLoadExtension():void
		{
			...
			d.showOnStage(KBlock.app.stage);
		}
...
//			"firmware",
		...
		{
			return KBlock.app.extensionManager.findExtensionByName(extName) != null;
		}
		...
		{
			return ApplicationManager.sharedManager().documents.resolvePath("KBlock/libraries");
		}
	}
}