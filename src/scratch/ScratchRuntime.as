...
package scratch {
	...
	public class ScratchRuntime {
		...
		public function ScratchRuntime(app:KBlock, interp:Interpreter) {
			this.app = app;
			this.interp = interp;
 ...
 * *********************************************************************/
		...
		public function example():void
		{
			...
			var file:File = new File(File.applicationDirectory.nativePath+"/examples");
			stopAll();
			file.addEventListener(Event.SELECT, fileSelected);
			file.browseForOpen("choose file to open", fileFilters);
		}
...
//				if(KBlock.app.isIn3D) obj.updateCostume();
