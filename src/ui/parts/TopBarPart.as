...
//		private const offlineNoticeFormat:TextFormat = new TextFormat(CSS.font, 12, CSS.white, true,null,null,null,null,"right");
		...
		public function TopBarPart(app:KBlock) {
			this.app = app;
			addButtons();
			refresh();
		}
		...
		public static function strings():Array {
			if (KBlock.app) {
//				KBlock.app.showFileMenu(Menu.dummyButton());
//				KBlock.app.showEditMenu(Menu.dummyButton());
				//KBlock.app.showSerialMenu(Menu.dummyButton());
//				KBlock.app.showExamplesMenu(Menu.dummyButton());
			}
...
//			}
	...
	//		addChild(socketMenu = makeMenuButton('Network',app.showNetworkMenu,true));
			...
			if(ApplicationManager.sharedManager().isCatVersion){
				addChild(shareMenu = makeMenuButton('Work Share', app.openShare, false));
				addChild(faqMenu = makeMenuButton('Manual', app.openFaq, false));
			}
