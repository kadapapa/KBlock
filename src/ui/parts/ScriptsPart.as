...
public class ScriptsPart extends UIPart {
	...
	private var uploadBt:Button = new Button(Translator.map("Upload to Controller"));
	...
	public function ScriptsPart(app:KBlock) {
		this.app = app;
...
//		messageTextPane.textField.scrollV = messageTextPane.textField.maxScrollV-1;
	...
	public function updatePalette():void {
		...
		if(!KBlock.app.stageIsArduino && KBlock.app.viewedObj() is ScratchStage){
	...
	public function updateTranslation():void{
		...
		uploadBt.setLabel(Translator.map("Upload to Controller"));
