	...
	public class FileUtil
	{
		...
		static public function PrintScreen():void
		{
			...
			var bmd:BitmapData = new BitmapData(
				KBlock.app.stage.stageWidth*scale,
				KBlock.app.stage.stageHeight*scale,true
			);
			var matrix:Matrix = new Matrix();
			matrix.scale(scale,scale);
			KBlock.app.scaleX = KBlock.app.scaleY = scale;
			bmd.drawWithQuality(KBlock.app, matrix, null, null, null, false, StageQuality.BEST);
			KBlock.app.scaleX = KBlock.app.scaleY = 1;
