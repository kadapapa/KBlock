package util.version
{
	...
	public class VersionManager 
	{
		...
		{
			localVersionFile = File.applicationStorageDirectory.resolvePath("KBlock");
		...
		public function start():void{
			...
			var req:URLRequest = new URLRequest("http://download.makeblock.cc/kblock/resources/resource_version.xml?time="+new Date().time);
			_reqLoader.load(req);
		...
		private function onReqError(evt:Event):void{
			...
			KBlock.app.extensionManager.clearImportedExtensions();
			KBlock.app.extensionManager.importExtension();
		}
