...
public class FunctionVideoMotion {
	...
	private function primVideoMotion(thread:Thread, argList:Array):void {
		...
		var obj:ScratchObj = KBlock.app.stagePane.objNamed(String(argList[1]));
	...
	private function startMotionDetector():void { KBlock.app.runtime.motionDetector = this }
	private function stopMotionDetector():void { KBlock.app.runtime.motionDetector = null }

	public function step():void {
		frameNum++;
		var sprites:Array = KBlock.app.stagePane.sprites();
		if (!(KBlock.app.stagePane && KBlock.app.stagePane.videoImage)) {
			prev = curr = null;
		...
		var img:BitmapData = KBlock.app.stagePane.videoImage.bitmapData;
